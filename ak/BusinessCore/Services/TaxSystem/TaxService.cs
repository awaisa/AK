...
namespace BusinessCore.Services.TaxSystem
{
    public class TaxService : ITaxService
    {
        ...
        public List<KeyValuePair<int, decimal>> GetPurchaseTaxes(int vendorId, int itemId, decimal quantity, decimal amount, decimal discount)
        {
            ...
            var intersectionTaxes = GetIntersectionTaxes(itemId, vendorId, BusinessCore.Domain.PartyTypes.Vendor);
        ...
        public List<KeyValuePair<int, decimal>> GetSalesTaxes(int customerId, int itemId, decimal quantity, decimal amount, decimal discount)
        {
            ...
            var intersectionTaxes = GetIntersectionTaxes(itemId, customerId, BusinessCore.Domain.PartyTypes.Customer);
        ...
        public IEnumerable<Tax> GetIntersectionTaxes(int itemId, int partyId, BusinessCore.Domain.PartyTypes partyType)
        {
            ...
            if (partyType == BusinessCore.Domain.PartyTypes.Customer)
            {
